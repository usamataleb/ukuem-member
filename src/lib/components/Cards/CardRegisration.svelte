<script lang="ts">
	...
	const { form, errors, state, handleChange, handleSubmit } = createForm({
		initialValues: {
			...
			position_in_ukuem: 'Senior Developer',
			occupation: 'Software Engineer',
			department_id: 2,
			employer: 'Tech Company',
			qualification: 'Bachelor of Science in Computer Science',
			specialization: 'Web Development',
			image_field: new ArrayBuffer(8), // Replace this with your actual ArrayBuffer
		...
		validationSchema: yup.object().shape({
			...
			image_field: yup
				.mixed()
				.test('isImage', 'Please upload a valid image file (PNG, JPG, JPEG, or SVG) && Size should not exceed 10 MB', (value) => {
