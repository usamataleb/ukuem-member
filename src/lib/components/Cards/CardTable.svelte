<script lang="ts">
  ...
  const bootstrap = "$lib/images/bootstrap.jpg";
  const angular = "$lib/images/angular.jpg";
  const sketch = "$lib/images/sketch.jpg";
  const react = "$lib/images/react.jpg";
  const vue = "$lib/images/react.jpg";

  const team1 = "$lib/images/team-1-800x800.jpg";
  const team2 = "$lib/images/team-2-800x800.jpg";
  const team3 = "$lib/images/team-3-800x800.jpg";
  const team4 = "$lib/images/team-4-470x470.png";
